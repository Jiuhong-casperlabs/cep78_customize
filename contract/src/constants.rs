...
pub const ARG_MULTI_TOKEN_META_DATA: &str = "multi_token_meta_data";
pub const ARG_TOKEN_OWNER: &str = "token_owner";
pub const ARG_MULTI_TOKEN_OWNERS: &str = "multi_token_owners";
...
pub const ENTRY_POINT_MULTI_MINT: &str = "multi_mint";
